...
const {getRecentEntries, getTaskEntries, addTaskEntries, setEntryValue, deleteEntry, deleteTaskEntries} = require('../controllers/taskHistoryController');

const router = express.Router();

router.get('/', getTaskEntries);
router.get('/recent', getRecentEntries);
router.post('/', addTaskEntries);
