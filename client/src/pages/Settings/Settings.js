        ...
        <div className={`Rounded-Container ${styles.container} Stack-Container To-Edge`}>
            ...
            <section className={'Stack-Container No-Gap'}>
                ...
                <InputWrapper label={'Password'}>
                    <Button filled={false} size={'small'} onClick={() => setChangePasswordVisible(current => !current)}>Change your Password</Button>
                </InputWrapper>
                <CollapsibleContainer isVisible={changePasswordVisible}>
                    ...
                    <InputWrapper label={'New Password'}>
                        <TextBoxInput width={'max'} value={newPassword} setValue={setNewPassword} placeholder={'New password'}/>
                    </InputWrapper>
                    <InputWrapper>
                        <Button filled={false} size={'small'} onClick={() => setChangePasswordVisible(current => !current)}>Save</Button>
