...
const TimeInput = ({
  ...
  const handleHourWheelEvent = useCallback(
    debounce((event) => {
  ...
  const handleMinuteWheelEvent = useCallback(
    debounce((event) => {
      const emSize = parseInt(window.getComputedStyle(event.target).fontSize);
  ...
  const setPickerPosition = () => {
    ...
    const emSize = parseFloat(
      window.getComputedStyle(pickerRef.current).fontSize
    );
    let top, left;
  ...
  return (
    <div className={styles.container}>
      <div className={styles.baseContainer} ref={baseRef}>
        ...
        <IconButton disabled={isDisabled} onClick={expandPicker}>
          <TbClock />
        </IconButton>
      </div>
      {pickerVisible &&
            ...
            >
              <div className={styles.relativeContainer}>
                <div className={styles.inputContainer}>
                  ...
                  <ul
                    className={styles.pickerContainer}
                    onScroll={handleMinuteWheelEvent}
                    ref={minutePickerRef}
                  >
                    <li></li>
                    <li>00</li>
                ...
                <IconButton disabled={isDisabled} onClick={collapsePicker}>
                  <TbClock />
                </IconButton>
              </div>
            </div>
